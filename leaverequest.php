...
<?php
  ...
  $laccept = mysqli_query($db,"SELECT l.TypesLeaveId,l.StateDate,l.EndDate,e.FirstName,e.LastName FROM leavedetails l JOIN employee e ON l.EmpId=e.EmployeeId WHERE LeaveStatus='Accept'");
  $ldenied = mysqli_query($db,"SELECT l.TypesLeaveId,l.StateDate,l.EndDate,e.FirstName,e.LastName FROM leavedetails l JOIN employee e ON l.EmpId=e.EmployeeId WHERE LeaveStatus='Denied'");

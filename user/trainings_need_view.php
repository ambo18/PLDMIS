...
<?php
    ...
    $total_query = mysqli_query($db, "SELECT COUNT(Detail_Id) as total FROM training_need WHERE EmpId = '$EmpId' AND TrainingType LIKE '%$SearchName%'"); 
    ...
    $sql = mysqli_query($db, "SELECT * FROM training_need WHERE EmpId = '$EmpId' AND TrainingType LIKE '%$SearchName%' LIMIT $RecordeLimit");
    ...
    if (isset($_POST['delete'])) {
        ...
        mysqli_query($db, "DELETE FROM training_need WHERE Detail_Id = '$employeeid'");
                ...
                <table id="table">
                    <thead>
                        <tr>
                            ...
                            <th style="text-transform: capitalize;">Semester</th>                      
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <form method="POST" action="#">
                                        ...
                                        <u><button type="submit" name="delete" class="btn btn-default"><i class="fa fa-trash" title="Delete"></i></button></u>
                                    </form>
                                </td>
                            </tr>
                        <?php } ?>

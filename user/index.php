...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url('../image/bg1.jpg') center center fixed; /* Replace 'path/to/your/image.jpg' with the actual path to your background image */
            background-size: cover;
            background-color: rgba(0, 0, 0, 0.8); /* Dark background color with some transparency */
        }
...
<body>
    ...
    <h1 class="text-white">Development of a Personnel Learning And Development Management Information System</h1>
    <br>
    <br>

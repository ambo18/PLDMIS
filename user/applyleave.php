...
<?php
  ...
  if (isset($_POST['Apply'])) {
    ...
    if (
      ($leave == 'Sick Leave' && $detailsLeave && ($detailsLeave == 'In Hospital' || $detailsLeave == 'Out Patient')) ||
      ($leave == 'Vacation Leave' && $detailsLeave && ($detailsLeave == 'Within Philippines' || $detailsLeave == 'Abroad')) ||
      ($leave == 'Special Privilege Leave' && $detailsLeave && ($detailsLeave == 'Within Philippines' || $detailsLeave == 'Abroad')) ||

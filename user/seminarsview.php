...
<?php
    ...
    $total_query = mysqli_query($db, "SELECT COUNT(Detail_Id) as total FROM seminardetails WHERE EmpId = '$EmpId'");
    ...
    $sql = mysqli_query($db, "SELECT * FROM seminardetails WHERE EmpId = '$EmpId' LIMIT $RecordeLimit");
    ...
    if (isset($_POST['delete'])) {
        ...
        mysqli_query($db, "DELETE FROM seminardetails WHERE Detail_Id = '$employeeid'");
        echo "<script>window.location='seminarsview.php';</script>";
    }
?>
        ...
        <div class="w3l-table-info">
            ...
            <div class="s-12 l-10">
                ...
                <table id="table">
                    <thead>
                        <tr>
                            <th style="text-transform: capitalize;">SeminarType</th>
                            <th style="text-transform: capitalize;">Date</th>
                            <th style="text-transform: capitalize;">Progress</th>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($sql)) { ?>
                            <tr>
                                <td><?php echo $row['SeminarType']; ?></td>

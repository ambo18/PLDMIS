...
<?php 
	...
	if(isset($_GET['positionedit']))
  {
    ...
    $edit = mysqli_query($db,"select * from position where PositionId='$positionedit'");
  ...
  $page = "";
  $pagelimit = 5;
  $positionid = mysqli_query($db,"select count(PositionId) total from position");
...
<div class="validation-system" style="margin-top: 0;">
 	...
 	<!---->
        <form method="POST" action="controller/ccity.php?positionedit=<?php echo isset($row['PositionId']) ? $row['PositionId'] : ''; ?>">
					...
					<div class="w3l-table-info">
					  <h2>Position</h2>
						...
						<tr>
							...
							<td><a href="?positionedit=<?php echo $row['PositionId']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="controller/ccity.php?positiondelete=<?php echo $row['PositionId']; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
						 </tr>	
